...
Fetch Details
                ...
                <AlertDialogDescription>
                    <h1 className="mb-2">Here are the details of following employee.</h1>
                    <h1 className="text-black">Name: {user.first_name} {user.last_name}</h1>
                    <h1 className="text-black">Location: {user.city}</h1>
                    <h1 className="text-black">Contact Number: {user.contact_number}</h1>
